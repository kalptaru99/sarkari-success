      ...
      <div style={{ maxWidth: '800px', margin: '40px auto', padding: '0 20px' }}>
        <div style={{ backgroundColor: 'white', borderRadius: '12px', padding: '40px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
          ...
          {[
            ...
            {
              title: "7. Your Rights",
              content: "You have the right to access, update, or delete your personal data at any time. You can delete your account by contacting us at <strong>contact.sarkarisuccess@gmail.com</strong>il.com. We will process your request within 7 business days."
            },
            {
            ...
            {
              title: "10. Contact Us",
              content: "For privacy-related queries, contact us at <strong>contact.sarkarisuccess@gmail.com</strong>il.com or write to us at Sarkari Success, India."
            },
          ].map((section, i) => (
