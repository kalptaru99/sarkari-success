...
export default function ToppersPlan() {
  ...
  const content = {
    en: {
      ...
      hero_sub: '20+ AI Features • 30,000+ Questions • Hindi & English • 11 Exams',
      ...
      why: [
        ...
        { emoji: '📊', title: '30,000+ Questions', desc: 'SSC, Railway, UPSC, Banking — chapter-wise questions for all exams' },
